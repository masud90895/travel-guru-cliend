...
const Contact=()=> {
    return (
        <div className="container mx-auto pt-16">
            <div className="lg:flex md:mt-[50px] mt-[15px]">
                <div className="xl:w-2/5 lg:w-2/5 bg-[#F9A51A] py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
                    <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
                        <h1 className="xl:text-4xl text-3xl pb-4 text-black font-bold">Get in touch</h1>
                        <p className="text-xl text-black pb-8 leading-relaxed font-normal lg:pr-4">Got a question about us? Are you interested in partnering with us? Have some suggestions or just want to say Hi? Just contact us. We are here to asset you.</p>
                        <div className="flex pb-4 items-center">
                            ...
                            <p className="pl-4 text-black text-base">+1 (308) 321 321</p>
                        </div>
                        <div className="flex items-center">
                            ...
                            <p className="pl-4 text-black text-base">Info@alphas.com</p>
                        </div>
                        ...
                        <a to="javascript:void(0)">
                            <p className="text-black pt-16 font-bold tracking-wide underline">View Job Openings</p>
                        </a>
                    </div>
                </div>
                <div className="xl:w-3/5 lg:w-3/5 bg-[#F9C51A] h-full md:pt-1 md:pb-2 md:pr-1  rounded-tr rounded-br">
                    <form id="contact" className="bg-white py-4 px-8 rounded-tr rounded-br">
                        ...
                        <div className="w-full mt-6">
                            ...
                            <button type="submit" className="focus:outline-none bg-[#F9A51A] transition duration-150 ease-in-out hover:border hover:border-[#F9A51A] hover:bg-white hover:text-black rounded text-white px-8 py-3 text-sm leading-6">
                                Submit
                            </button>
                        </div>
                    </form>
